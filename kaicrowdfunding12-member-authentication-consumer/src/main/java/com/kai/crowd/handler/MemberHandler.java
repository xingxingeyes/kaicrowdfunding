...
import com.kai.crowd.api.RedisRemoteService;
import com.kai.crowd.config.ShortMessageProperties;
...
import com.kai.crowd.entity.vo.MemberVO;
...
public class MemberHandler {
    ...
    public String login(@RequestParam("loginacct") String loginacct, @RequestParam("userpswd") String userpswd, ModelMap modelMap, HttpSession session) {
        // 1.调用远程届酷狗根据账号查询MemberPO对象
        ResultEntity<MemberPO> resultEntity = mySQLRemoteService.getMemberPOByLoginAccRemote(loginacct);
    ...
    public String register(MemberVO memberVO, ModelMap modelMap) {
        ...
        if (saveMemberResultEntity.FAILED.equals(saveMemberResultEntity.getResult())) {
