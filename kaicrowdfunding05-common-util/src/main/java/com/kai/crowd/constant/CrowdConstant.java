package com.kai.crowd.constant;

public class CrowdConstant {

    public static final String MESSAGE_LOGIN_FAILED = "抱歉！账号密码错误！请重新输入！";
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USE = "抱歉这个账号已经被使用了！";
    public static final String MESSAGE_ACCESS_FORBIDDEN = "请登录后在访问！";
    ...
    public static final String MESSAGE_DETAIL_PIC_UPLOAD_EMPTY = "详情图片上传失败";
    public static final String MESSAGE_TEMPLE_PROJECT_MESSING = "临时存储的project对象丢失";
