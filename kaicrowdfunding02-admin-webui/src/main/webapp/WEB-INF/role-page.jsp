...
<%-- 页码插件，注意先后顺序，pagination要在jQuery的后面--%>
...
<script type="text/javascript">
    $(function () {
        ...
        // 传统的时间绑定方式只能在第一个页面有效，翻页后失效了
        // $(".pencilBtn").click(function () {
        //     alert("aaa...");
        // });

        // 使用jQuery对象的on()函数可以解决上面问题
        // ①首先找到所有“动态生成”的元素驸着的“静态”元素
        // ②on()函数的第一个参数是事件类型
        ...
        $("#rolePageBody").on("click", ".pencilBtn", function () {
            ...
            // 为了让执行更新的按钮能够获取roleId的值，把它放在全局变量上
        ...
        $("#summaryBox").click(function () {
            // ①获取当前多选框自身状态
            var currentsStatus = this.checked;
            // ②用当前多选框的状态设置其它的多选框
            $(".itemBox").prop("checked", currentsStatus);
        });
        // 11.全选、全不选的反向操作
        ...
        $("#assignBtn").click(function () {
            ...
            var requestBody = {
                ...
                //为了服务器端handle方法能够统一使用List<Ingeger>方式接受收据，roleId也存入数组
